...
// displayProblem : affiche le probleme d'optimisation de OSI_SOLVER
...
// updateYhat : met à jour ŷ avant pour générer le sous-problème suivant
void updateYhat(OsiClpSolverInterface *PPR_OSI_SOLVER,
    ...
    if(prob_LB < PPR_OSI_SOLVER->getObjValue())
...
// modifySubProblem : modifie le sous-problème dans le cas où celui-ci est non-borné
...
// generateSubProblem : construit le sous-problème
...
// generateMasterProblem : génère le premier problème principal
...
// updateMasterProblem : ajoute les nouvelles contraintes au problème principal restreint
